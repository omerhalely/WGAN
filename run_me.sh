...
python3 main.py --model "WGAN" --model-name "WGAN_CIFAR10" --data "CIFAR10" --epochs 5 --train true
# Testing WGAN_CIFAR10.
python3 main.py --model "WGAN" --model-name "WGAN_CIFAR10" --data "CIFAR10"

# Training WGAN on FashionMNIST dataset.
python3 main.py --model "WGAN" --model-name "WGAN_FashionMNIST" --data "FashionMNIST" --epochs 5 --train True
...
python3 main.py --model "DCGAN" --model-name "DCAN_CIFAR10" --data "CIFAR10" --epochs 5 --train True
# Testing WGAN_CIFAR10.
python3 main.py --model "DCGAN" --model-name "DCGAN_CIFAR10" --data "CIFAR10"

# Training WGAN on FashionMNIST dataset.
python3 main.py --model "DCGAN" --model-name "DCGAN_FashionMNIST" --data "FashionMNIST" --epochs 5 --train True
# Testing WGAN_FashionMNIST.
